...
query = f'SELECT * FROM football_betting fb WHERE fb.match_id in (select fm.match_id from football_matches fm where ("date" >= \'2018-08-01\') and ("date" <= \'2022-08-01\') and ("league" in {LEAGUES}))'
...
data.to_csv('../data/football_odds.csv')